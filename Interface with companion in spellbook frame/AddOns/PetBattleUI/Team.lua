...
function PetBattleUI_Team_UpdateSlot(slotIndex, spellID, icon, name, tipo, d1, d2, d3, creatureID)

    local button = GetTeamSlotButton(slotIndex)
...
-- ============================================================
-- DETECTAR TOGGLE SPELLBOOK COMPANION
-- ============================================================
